    ...
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        ...
        <div class="card-body pt-5">
            ...
            <form id="create-form" class="form fv-plugins-bootstrap5 fv-plugins-framework" >
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" id="name" value="{{$language->lang_name}}" >
                        <!--end::Input-->
                    ...
                    <div class="col-6">
                        <div class="fv-row mb-7 fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="code" class="form-control form-control-solid" id="code" value="{{$language->lang_code}}">
                            <!--end::Input-->
                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                   </div>
             ...
             <div class="d-flex justify-content-begin">
                ...
                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                    <!--begin::Input-->
                    <input class="form-check-input" id="active" type="checkbox"  @if($language->active) checked @endif>
                    <!--end::Input-->
                    <!--begin::Label-->
            ...
            <div class="d-flex justify-content-center">
                ...
                <!--end::Button-->
                <!--begin::Button-->
                <button type="button" onclick="performUpdate('{{$language->id}}')"  class="btn btn-primary">
...
<script>
   ...
   var formData = new FormData();
       ...
       formData.append('lang_code',document.getElementById('code').value);
       formData.append('active', document.getElementById('active').checked ?1:0);


       formData.append('_method','PUT');

       axios.post('/cms/languages/{{$language->id}}', formData)
       .then(function (response) {
           console.log(response);
           toastr.success(response.data.message);
           window.location.href = '/cms/languages';
       })
