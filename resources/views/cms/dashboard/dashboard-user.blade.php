    ...
    <div class="col-xl-6">
        ...
        <a href="#" class="card bg-dark hoverabl card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-white fw-bold fs-2 mb-2 mt-5">{{('cms.brand')}}</div>
    ...
    <div class="col-xl-6">
        ...
        <a href="#" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-white fw-bold fs-2 mb-2 mt-5">{{('cms.category')}}</div>
    ...
    <div class="col-xl-6">
        ...
        <a href="#" class="card bg-info hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-white fw-bold fs-2 mb-2 mt-5">{{('cms.model')}}</div>
    ...
    <div class="col-xl-6">
        ...
        <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-white fw-bold fs-2 mb-2 mt-5">{{('cms.spare_part')}}</div>
