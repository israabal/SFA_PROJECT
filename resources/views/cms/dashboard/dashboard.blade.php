...
@section('main-pg-md',__('cms.Dashboard'))
@section('page-md',__('cms.list'))
@section('Content')
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_products_table">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" aria-label="Joined Date: activate to sort column ascending">{{__('cms.customers')}}</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" aria-label="Joined Date: activate to sort column ascending">{{__('cms.Models')}}</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($problms as $problems)
                                <tr class="odd">
                                    <td> {{$problems->user->name}}</td>
                                    <td>
                                        <span class="fw-bold">{{$problems->models->name}}</span>
                                    </td>
                                    <td class="d-flex align-items-center">
                                        <div class="d-flex flex-column">
                                            <p class="text-gray-800 text-hover-primary mb-1"> {{ $problems->details ??'NULL' }}</p>
                                        </div>
                                    </td>
                ...
                <div id="kt_ecommerce_products_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_products_table">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" aria-label="Two-step: activate to sort column ascending">#</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" aria-label="Two-step: activate to sort column ascending">{{__('cms.problem_details')}}</th>
...
@elseif(auth('user')->user()->user_type=='customers')
<div id="kt_app_content" class="app-content flex-column-fluid">
    <!--begin::Content container-->
    <div id="kt_app_content_container" class="app-container container-xxl">
        <!--begin::Products-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_products_table">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr class="odd">
                                    ...
                                    <td>
                                        <span class="fw-bold">{{$pro->models->name}}</span>
                                    </td>
                                </tr>
                                @endforeach
