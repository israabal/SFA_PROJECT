@extends('cms.parent')
@section('title',__('cms.ass'))
@section('main-pg-md','dshjsdfsjducfg')
@section('styles')
@section('Content')
...
<!--end::Svg Icon-->
                <div class="text-white fw-bold fs-2 mb-2 mt-5">{{__('cms.users')}}</div>
                <div class="fw-semibold text-white">{{$users->count()}}</div>
            </div>
            <!--end::Body-->
        </a>
        ...
        <div class="card card-xl-stretch mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="d-flex align-items-center mb-7">
                        ...
                        <div class="flex-grow-1">
                        <span class="text-dark fw-bold text-hover-primary fs-6" style="margin-left:65px;">{{$problm->models->name}}</span>
                        </div>
                        <!--end::Text-->
                    </div>
