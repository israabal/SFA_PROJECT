    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">update Role</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
            ...
            <form id="kt_account_profile_details_form create-form" class="form">
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        name="username" class="form-control form-control-lg form-control-solid" placeholder="username" value="Keenthemes" />
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label  for="name" class="col-lg-4 col-form-label required fw-semibold fs-6">Gard Name</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <!--begin::Input-->
