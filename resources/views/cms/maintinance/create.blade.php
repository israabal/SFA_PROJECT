...
@section('page-md',__('cms.create_maintenance'))
@section('Content')
<div class="col-xl-12">
    <!--begin::Contacts-->
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        ...
        <div class="card-header pt-7" id="kt_chat_contacts_header">
            ...
            <div class="card-title">
                ...
                <!--end::Svg Icon-->
                <h2>{{__('cms.create_maintenance')}}</h2>
            </div>
            <!--end::Card title-->
        </div>
        <!--end::Card header-->
...
<script>
    function performStore() {
        ...
        formData.append('d_log', document.getElementById('d_log').value);
        formData.append('d_lat', document.getElementById('d_lat').value);
        formData.append('technecal_id', document.getElementById('technecal_id').value);
        formData.append('active', document.getElementById('active').checked ? 1:0);
        formData.append('app_status', document.getElementById('app_status').value);

        axios.post('/cms/main', formData)
