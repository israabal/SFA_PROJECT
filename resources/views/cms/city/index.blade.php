...
@section('main-pg-md',__('cms.cities_Management'))
@section('page-md',__('cms.cities_list'))
@section('Content')
        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <!--begin::Add product-->
                    <a href="{{route('cities.create' )}}" class="btn btn-primary">{{__('cms.create_new_city')}}</a>
                    <!--end::Add product-->
                </div>
                <!--end::Card toolbar-->
            </div>
                ...
                <div id="kt_ecommerce_products_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_products_table">
                    ...
                    <tr class="odd">
                            ...
                            <td class="text-end pe-0" data-order="16">
                                <span class="fw-bold ms-3">{{$city->created_at}}</span>
                            </td>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a href="#" onclick="confirmDelete('{{$city->id}}', this)"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
