@extends('cms.parent')
@section('title',__('cms.city'))
@section('page-lg',__('cms.home'))
@section('main-pg-md',__('cms.city_Management'))
@section('page-md',__('cms.edit_city'))
@section('styles')
            ...
            <form id="edit-form" class="form fv-plugins-bootstrap5 fv-plugins-framework" >
                ...
                <label class="col-lg-4 col-form-label required fw-semibold fs-6">
                        ...
                        <select class="form-select form-select-solid form-select-lg" data-control="select2"
                            name="country_id" id="country_id" data-select2-id="select2-data-10-uyhn">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="button" onclick="performUpdate('{{$city->id}}')" class="btn btn-primary">
