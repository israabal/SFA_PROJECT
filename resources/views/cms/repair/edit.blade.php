...
@section('page-md',__('cms.edit_repair'))
@section('Content')
<div class="col-xl-12">
    <!--begin::Contacts-->
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-12 fv-row">
                        <select class="form-select form-select-solid form-select-lg" data-control="select2"
                            ...
                            <option value="accepted" @if( $repair->app_status == 'accepted') selected
                                @endif>{{__('cms.accepted')}}
                            </option>
                            <option value="refused" @if( $repair->app_status == 'refused') selected
