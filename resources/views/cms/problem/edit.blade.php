...
<div class="col-xl-12">
    ...
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        ...
        <div class="card-body pt-5">
            <!--begin::Form-->
            <form id="edit-form" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                @csrf
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number" class="form-control form-control-solid" id="d_log" value="{{ $problem->d_log }}">
                    <!--end::Input-->
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number" class="form-control form-control-solid" id="d_lat" value="{{ $problem->d_lat }}">
                    <!--end::Input-->
                    <div class="fv-plugins-message-container invalid-feedback"></div>
                </div>
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" class="form-control form-control-solid" id="details"  value="{{ $problem->details }}">
                    <!--end::Input-->
                    <div class="fv-plugins-message-container invalid-feedback"></div>
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <select id="product_models_id" name=" product_models_id"
                            class="form-select form-select-solid form-select-lg" data-control="select2"
                           data-select2-id="select2-data-10-uyhn">
                            @foreach ($sparePartModels as $sparePartModel)
                            <option data-kt-flag="flags/indonesia.svg" value="{{ $sparePartModel->id }}">{{$sparePartModel->name}}
                            </option>
                        ...
                        <!--end::Hint-->
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <!--end::Button-->
                                <!--begin::Button-->
                                <button type="button" onclick="performUpdate('{{$problem->id}}')" class="btn btn-primary">
