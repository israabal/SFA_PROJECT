...
@section('page-md',__('cms.edit_brand'))
@section('Content')
<div class="col-xl-12">
    <!--begin::Contacts-->
            ...
            <form id="create-form" class="form fv-plugins-bootstrap5 fv-plugins-framework" >
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" id="name" value="{{$brand->name}}">
                        <!--end::Input-->
                    ...
                    <div class="mb-7">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body  pt-0">
                                ...
                                <style>.image-input-placeholder { background-image: url({{Storage::url($brand->image ?? '')}}); } [data-theme="dark"] .image-input-placeholder { background-image: url('assets/media/svg/files/blank-image-dark.svg'); }</style>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="button" onclick="performUpdate('{{$brand->id}}')" class="btn btn-primary">
...
<script>
   ...
   var formData = new FormData();
    ...
    //    formData.append('code',document.getElementById('code').value);
       ...
       if(document.getElementById('brand_image').files[0] != undefined) {
           formData.append('image',document.getElementById('brand_image').files[0]);
       }
       formData.append('_method','PUT');

       axios.post('/cms/brands/{{$brand->id}}', formData)
       .then(function (response) {
           console.log(response);
           toastr.success(response.data.message);
           window.location.href = '/cms/brands';
       })
