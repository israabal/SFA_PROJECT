...
@section('page-md',__('cms.brands_list'))
@section('Content')
                    ...
                    <tr class="odd">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                        <div class="symbol-label">
                                            <img src="{{Storage::url($brand->image ?? '')}}"  alt="Emma Smith" class="w-100">
                                        </div>
                                    </a>
                                    <!--end::Thumbnail-->
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{$brand->name}}</a>
                                        <!--end::Title-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a  href="{{route('brands.edit', $brand->id )}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    ...
                                    <a href="#" onclick="confirmDelete('{{$brand->id}}', this)"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
