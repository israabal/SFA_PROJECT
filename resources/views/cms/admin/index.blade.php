                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Svg Icon-->{{__('cms.add_admin')}}</a>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                    ...
                    <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_users">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1" aria-label="User: activate to sort column ascending" style="width: 206.375px;">{{__('cms.admin')}}</th>
                        ...
                        <tr class="odd">
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="../../demo1/dist/apps/user-management/users/view.html">
                                            <div class="symbol-label">
                                                <img src="{{Storage::url($admin->image ?? '')}}"  alt="Emma Smith" class="w-100">
                                            </div>
                                        </a>
                                    </div>
                                    <!--end::Avatar-->
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="../../demo1/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">{{$admin->name}}</a>
                                ...
                                <!--end::Last login=-->
                                <!--begin::Two step=-->
                                <td><span class="badge @if($admin->active) bg-success @else bg-danger @endif">{{$admin->active_status}}</span>

                                <!--end::Two step=-->
                                <!--begin::Joined-->
                                <td data-order="2022-06-20T22:10:00+03:00">{{$admin->created_at->format('Y-m-d H:ia')}}</td>
                                <!--begin::Joined-->
                                <!--begin::Action=-->
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        ...
                                        <a href="#"  onclick="confirmDelete('{{$admin->id}}', this)" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
