        ...
        <div class="card-body pt-5">
            ...
            <form id="create-form" class="form fv-plugins-bootstrap5 fv-plugins-framework" >
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" class="form-control form-control-solid" id="name"  value="{{Auth::user()->name}}">
                    <!--end::Input-->
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="email" class="form-control form-control-solid" id="email"  value="{{Auth::user()->email}}">
                    <!--end::Input-->
                <div class="fv-plugins-message-container invalid-feedback"></div></div>
