                    ...
                    <div class="mt-1">
                        ...
                        <div class="image-input image-input-outline image-input-placeholder image-input-empty" data-kt-image-input="true">
                            ...
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" aria-label="Change avatar" data-bs-original-title="Change avatar" data-kt-initialized="1">
                                ...
                                <input type="hidden" name="avatar_remove" value="{{$admin->image}}" >
                                <!--end::Inputs-->
                            </label>
                            <!--end::Edit-->
                            <!--begin::Cancel-->
...
<!--end::Input group-->
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="email" class="form-control form-control-solid" id="email" value="{{$admin->email}}">
                    <!--end::Input-->
                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                <div class="">
                    <!--begin::Switch-->
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="button" onclick="performUpdate('{{$admin->id}}')" class="btn btn-primary">
