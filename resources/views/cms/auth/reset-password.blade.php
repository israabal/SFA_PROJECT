...
<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
            ...
            <div class="d-flex flex-center w-lg-50 p-10">
                ...
                <div class="card rounded-3 w-md-550px">
                    ...
                    <div class="card-body p-10 p-lg-20">
                        <!--begin::Form-->
                        <form class="form" novalidate="novalidate" id="kt_password_reset_form">
                            <!--begin::Heading-->
                            <div class="text-center mb-10">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">{{__('cms.Forgot_Password')}} ?</h1>
                                <!--end::Title-->
                                <!--begin::Link-->
                                <div class="text-gray-500 fw-semibold fs-6">
                                    {{__('cms.Enter_your_email_to_reset_your_password')}}.
                                </div>
                                <!--end::Link-->
                            </div>
                            <!--begin::Heading-->
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Email-->
                                <input type="text" placeholder="{{__('cms.email')}}" name="email" id="reset_email"
                                    autocomplete="off" class="form-control bg-transparent" />
                                <!--end::Email-->
                            </div>
                            <!--begin::Actions-->
                            <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                                <button onclick="performForgotPassword('{{$guard}}')" type="button"
                                ...
                                <a href="{{route('cms.login',$guard)}}" class="btn btn-light">{{__('cms.cancel')}}</a>
                            </div>
                            <!--end::Actions-->
                        </form>
                        <!--end::Form-->
    ...
    // <script src="{{asset('cms/assets/js/custom/authentication/reset-password/reset-password.js')}}"></script>
