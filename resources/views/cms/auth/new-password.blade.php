...
<html lang="en">
	...
	@endif		<!--end::Global Stylesheets Bundle-->
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('{{asset('cms/assets/media/auth/bg4.jpg')}}'); } [data-theme="dark"] body { background-image: url('{{asset('cms/assets/media/auth/bg4-dark.jpg')}}'); }</style>
			<!--end::Page bg image-->
						...
						<div class="card-body p-10 p-lg-20">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="../../demo1/dist/authentication/layouts/creative/sign-in.html" action="#">
								...
								<div class="fv-row mb-8">
									...
									<input type="password" placeholder="Repeat Password" name="password_confirmation" id="password_confirmation" autocomplete="off" 
                                    class="form-control bg-transparent" />
									<!--end::Repeat Password-->
								</div>
								<!--end::Input group=-->
		...
		<!--end::Root-->
		<!--begin::Javascript-->
		<script>var hostUrl = "cms/assets/";</script>
		...
		<script src="{{asset('cms/assets/js/custom/authentication/password-reset/new-password.js')}}"></script>
