...
@section('page-md',__('cms.edit_problem_status'))
@section('styles')
    ...
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        ...
        <div class="card-header pt-7" id="kt_chat_contacts_header">
            ...
            <div class="card-title">
                ...
                <!--end::Svg Icon-->
                <h2>{{__('cms.create_problem_status')}}</h2>
            </div>
            <!--end::Card title-->
        </div>
        <!--end::Card header-->
            ...
            <form id="create-form" class="form fv-plugins-bootstrap5 fv-plugins-framework" >
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" id="name_ar" value="{{$problem_status->name_ar}}" >
                        <!--end::Input-->
                 ...
                 <div class="col-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" id="name_en" value="{{$problem_status->name_en}}" >
                        <!--end::Input-->
                    <div class="fv-plugins-message-container invalid-feedback"></div></div>
                 </div>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="button" onclick="performUpdate('{{$problem_status->id}}')" class="btn btn-primary">
...
formData.append('name_en',document.getElementById('name_en').value);  
    formData.append('_method','PUT');
      axios.post('/cms/problem_status/{{$problem_status->id}}', formData)
