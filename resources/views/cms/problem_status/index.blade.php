@extends('cms.parent');
@section('title',__('cms.problem_status'))
@section('page-lg',__('cms.home'))
@section('main-pg-md',__('cms.problem_status_Management'))
@section('page-md',__('cms.problem_status_list'))
@section('Content')
        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <!--begin::Add product-->
                    <a href="{{route('problem_status.create' )}}" class="btn btn-primary">{{__('cms.create_new_problem_status')}}</a>
                    <!--end::Add product-->
                </div>
                <!--end::Card toolbar-->
            </div>
                ...
                <div id="kt_ecommerce_products_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_products_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-200px sorting" tabindex="0" aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1" aria-label="Product: activate to sort column ascending" style="width: 206.828px;">{{__('cms.problem_status')}}</th>
                            <th class="min-w-200px sorting" tabindex="0" aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1" aria-label="Product: activate to sort column ascending" style="width: 206.828px;">{{__('cms.problem_status_en')}}</th>
...
<script>
    ...
    function performDelete(id, reference) {
        axios.delete('/cms/problem_status/'+id)
    ...
    axios.post('/cms/problem_status/change-status/' + id)
        .then(function(response) {
            console.log(response);
            toastr.success(response.data.message);
             window.location.href = '/cms/problem_status/';
        })
        .catch(function(error) {
            console.log(error.response);
            toastr.error(error.response.data.message);
