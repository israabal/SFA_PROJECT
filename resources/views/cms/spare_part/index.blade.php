                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                        <div class="symbol-label">
                                            <img src="{{Storage::url($sparepart->main_image ?? '')}}"  alt="Emma Smith" class="w-100">
                                        </div>
                                    </a>
                                    <!--end::Thumbnail-->
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{$sparepart->name}}</a>
                                        <!--end::Title-->
                                    </div>
                                </div>
                            </td>
